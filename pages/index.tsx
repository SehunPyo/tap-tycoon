...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-4 bg-white text-gray-800">
      ...
      <p></p>
      <p className="mb-4">--------------------------- ✨ 주요 변경 및 신규 기능 ✨ ---------------------------</p>
      <p></p>
      ...
      <p className="mb-4">•  <b>[UI 및 편의성 개선]</b></p>
      <p className="mb-4">    -   새로고침 버튼 클릭 시, 적립 중인 코인도 함께 저장됩니다.</p>
      <p className="mb-4">    -   프로그램 종료 시 진행 중이던 데이터가 저장됩니다.</p>
      <p className="mb-4">•  <b>[버그 수정 및 안정화]</b></p>
      <p className="mb-4">    -   펫 관련 팝업(가방, 활동)의 아이템 선택 및 사용 기능이 정상적으로 동작하도록 수정되었습니다.</p>
