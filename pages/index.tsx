...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-4 bg-white text-gray-800">
      ...
      <p className="mb-4">•  코인 배팅 기능이 추가되었습니다! 이제 코인을 사용하여 배팅하고 당첨금을 노릴 수 있습니다.</p>
      <p className="mb-4">•  건물 관리 버튼에 마우스를 올려보세요! 보유 건물과 구매 가능 건물을 함께 볼 수 있습니다.</p>
      <p className="mb-4">•  자산 보유 랭킹에 마우스를 올려보세요! 닉네임과 TOP 10이 표시됩니다.</p>
      <p className="mb-4">-----------------------------------------------------</p>
